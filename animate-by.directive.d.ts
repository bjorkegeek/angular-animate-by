 ...
 */
export declare class AnimateByDirective<T> implements OnInit, OnDestroy {
    private templateRef;
    private cd;
    private viewContainer;
    private elRef;
    timings: any;
    animateByOptions: AnimateByOptions;
    private stack;
    private current;
    private window;
    private animId;
    private inited;
    constructor(templateRef: TemplateRef<any>, cd: ChangeDetectorRef, viewContainer: ViewContainerRef, elRef: ElementRef);
    ngOnInit(): void;
    ngOnDestroy(): void;
    animateBy: T;
    private newCurrent(v);
    private removeCurrent();
    private scheduleAnimationFrame();
    private doAnimationFrame(clock);
    private removeStackEntry(stackEntry);
}
